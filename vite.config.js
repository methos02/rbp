...
export default defineConfig({
  ...
  plugins: [
    ...
    liveReload([
      ...
      // for example:
      __dirname + '/(app|config|ressources)/**/*.php',
  ...
  // config
  root: './ressources',
  base: process.env.APP_ENV === 'development' ? '/' : '/build/',
  ...
  build: {
    ...
    // our entry
    rollupOptions: {
      input: path.resolve(__dirname, 'ressources/js/app.js'),
    }
  },
